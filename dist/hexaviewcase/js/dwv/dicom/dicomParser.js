...
dwv.dicom.DicomParser.prototype.parse = function(buffer)
{
    ...
    var decoder = null;
    var samplePerPixel = this.getDicomElements().getFromKey("x00280002");
	var bitsStored = this.getDicomElements().getFromKey("x00280102")
    if( isJpegLossless ) {
        ...
        if(samplePerPixel===3)
			this.pixelBuffer = new Uint8Array(decoded.buffer);
        else{
			if(bitsStored>8)
